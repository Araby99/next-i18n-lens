      ...
      <header className="h-16 bg-[#080b11]/90 backdrop-blur-md border-b border-slate-900/60 px-8 flex items-center justify-between shrink-0 select-none">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 font-medium tracking-wider uppercase mt-0.5">
              Live Visual Translation Studio
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <div
            ...
            title={`${coveragePercentage}% of keys translated`}
          >
        ...
        <div className="w-[300px] bg-slate-900 border border-slate-800 rounded-2xl flex flex-col h-full shadow-2xl overflow-hidden shrink-0">
          ...
          <div className="p-4 border-b border-slate-800/80 shrink-0 bg-slate-900/40 space-y-3">
            <div className="relative">
              ...
              />
              <svg
                className="w-3.5 h-3.5 text-slate-600 absolute left-3 top-2.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
                ...
                <button
                  ...
                  title={
                    visibleKeys === null
                      ...
                      : 'Only show keys on the current page'
                  }
                >
                  Page Keys
                </button>
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <p className="text-xs text-slate-400 mt-2 leading-relaxed">
              You have unsaved edits in your translation. Selecting another element will discard
              these modifications. Do you want to discard your edits?
            </p>
